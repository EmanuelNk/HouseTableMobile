...
class _DashboardState extends State<Dashboard> {
  static LoanInfo loan_info = LoanInfo(
      startRenovation: 'ASAP',
      countrySubdivision: 'NY',
      dataProperty: DataProperty(
          bathrooms: 3, bedrooms: 2, squareFootage: 1027, yearbuilt: 1917),
      debt: 100000,
      estPrice: 200000,
  ...
  static List<LoanInfo> loansInfo = [
    LoanInfo(
        startRenovation: 'ASAP',
        countrySubdivision: 'NY',
        dataProperty: DataProperty(
  ...
  static List<HouseInfo> loanRequestList = [
    HouseInfo(
        ...
        address: loan_info.get_adress_line_1(),
        date: "12.05.98",
        value: 12000,
        deals: 4,
        loanInfo: loan_info),
  ...
  List<StatusInfo> statusesInfo = [
    StatusInfo(
        status: 'Pending Housetable approval',
        labelColor: Color(0xFF5F83A7),
        housesInfo: loanRequestList,
        deals: loanRequestList.length,
        value: 1786200),
    StatusInfo(
        status: 'Pending seller approval',
        labelColor: Color(0xFF6EB4A3),
        housesInfo: loanRequestList,
        deals: loanRequestList.length,
        value: 2500200),
    StatusInfo(
        status: 'Completed',
        labelColor: Color(0xFF70BB74),
        housesInfo: loanRequestList,
        deals: loanRequestList.length,
        value: 1000222),
    StatusInfo(
        status: 'Rejected by Housetable',
        labelColor: Color(0xFF9C4646),
        housesInfo: loanRequestList,
        deals: loanRequestList.length,
        value: 1600200),
    StatusInfo(
        status: 'Rejected by seller',
        labelColor: Color(0xFF995433),
        housesInfo: loanRequestList,
        deals: loanRequestList.length,
        value: 1034500),
  ];
